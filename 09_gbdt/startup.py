...
if __name__ == '__main__':
    ...
    data_file = 'D:/nowcoder_coding/interview/GBDT/data/credit.data.csv'
    dateset = DataSet(data_file)
    gbdt = GBDT(max_iter=2, sample_rate=0.8, learn_rate=0.5, max_depth=7, loss_type='binary-classification')
